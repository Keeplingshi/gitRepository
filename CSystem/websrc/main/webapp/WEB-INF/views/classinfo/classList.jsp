...
<form id="formId" action="${pageContext.request.contextPath}/class/classSearchList" method="post">
	...
	function deleteclass(classId)
	{
		...
		layer.confirm('是否确定删除？', {
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载班级列表
			$.post("${pageContext.request.contextPath}/class/delete/"+classId, function(result){
				if(result=='success'){
					//默认加载班级列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
