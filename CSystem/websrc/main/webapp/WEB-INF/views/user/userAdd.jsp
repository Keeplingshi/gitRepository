...
<form id="userAddFormId" action="${pageContext.request.contextPath}/user/save" method="post">
	<table>
		<tr>
		...
		<tr>
			...
			<td class="lestb">
				<input type="text" id="password" name="password" class="input_text_a" placeholder="请输入密码">
			</td>
		</tr>
		<tr>
