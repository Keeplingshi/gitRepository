...
<form id="formId" action="${pageContext.request.contextPath}/major/majorSearchList" method="post">
	...
	function deletemajor(majorId)
	{
		...
		layer.confirm('是否确定删除？', {
		    btn: ['确定','取消'] //按钮
	 		...
	 		//默认加载专业列表
			$.post("${pageContext.request.contextPath}/major/delete/"+majorId, function(result){
				if(result=='success'){
					//默认加载专业列表
		        	$("#formId").ajaxSubmit(function(data){
		        	 	$("#content_page").html(data);
